...
void main() {
	...
	`}var so=class extends Nt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new ai(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		}`},Qc=class{constructor(){this.isPass=!0,this.enabled=!0,this.needsSwap=!0,this.clear=!1,this.renderToScreen=!1}setSize(){}render(){console.error(`THREE.Pass: .render() must be implemented in derived pass.`)}dispose(){}},$c=new sa(-1,1,1,-1,0,1),el=new class extends vr{constructor(){super(),this.setAttribute(`position`,new or([-1,3,0,-1,-1,0,3,-1,0],3)),this.setAttribute(`uv`,new or([0,2,0,0,2,0],2))}},tl=class{constructor(e){this._mesh=new Hr(el,e)}dispose(){this._mesh.geometry.dispose()}render(e){e.render(this._mesh,$c)}get material(){return this._mesh.material}set material(e){this._mesh.material=e}},nl=class extends Qc{constructor(e,t=`tDiffuse`){super(),this.textureID=t,this.uniforms=null,this.material=null,e instanceof bi?(this.uniforms=e.uniforms,this.material=e):e&&(this.uniforms=_i.clone(e.uniforms),this.material=new bi({name:e.name===void 0?`unspecified`:e.name,defines:Object.assign({},e.defines),uniforms:this.uniforms,vertexShader:e.vertexShader,fragmentShader:e.fragmentShader})),this._fsQuad=new tl(this.material)}render(e,t,n){this.uniforms[this.textureID]&&(this.uniforms[this.textureID].value=n.texture),this._fsQuad.material=this.material,this.renderToScreen?(e.setRenderTarget(null),this._fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this._fsQuad.render(e))}dispose(){this.material.dispose(),this._fsQuad.dispose()}},rl=class extends Qc{constructor(e,t){super(),this.scene=e,this.camera=t,this.clear=!0,this.needsSwap=!1,this.inverse=!1}render(e,t,n){let r=e.getContext(),i=e.state;i.buffers.color.setMask(!1),i.buffers.depth.setMask(!1),i.buffers.color.setLocked(!0),i.buffers.depth.setLocked(!0);let a,o;this.inverse?(a=0,o=1):(a=1,o=0),i.buffers.stencil.setTest(!0),i.buffers.stencil.setOp(r.REPLACE,r.REPLACE,r.REPLACE),i.buffers.stencil.setFunc(r.ALWAYS,a,4294967295),i.buffers.stencil.setClear(o),i.buffers.stencil.setLocked(!0),e.setRenderTarget(n),this.clear&&e.clear(),e.render(this.scene,this.camera),e.setRenderTarget(t),this.clear&&e.clear(),e.render(this.scene,this.camera),i.buffers.color.setLocked(!1),i.buffers.depth.setLocked(!1),i.buffers.color.setMask(!0),i.buffers.depth.setMask(!0),i.buffers.stencil.setLocked(!1),i.buffers.stencil.setFunc(r.EQUAL,1,4294967295),i.buffers.stencil.setOp(r.KEEP,r.KEEP,r.KEEP),i.buffers.stencil.setLocked(!0)}},il=class extends Qc{constructor(){super(),this.needsSwap=!1}render(e){e.state.buffers.stencil.setLocked(!1),e.state.buffers.stencil.setTest(!1)}},al=class{constructor(e,t){if(this.renderer=e,this._pixelRatio=e.getPixelRatio(),t===void 0){let n=e.getSize(new K);this._width=n.width,this._height=n.height,t=new Nt(this._width*this._pixelRatio,this._height*this._pixelRatio,{type:T}),t.texture.name=`EffectComposer.rt1`}else this._width=t.width,this._height=t.height;this.renderTarget1=t,this.renderTarget2=t.clone(),this.renderTarget2.texture.name=`EffectComposer.rt2`,this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2,this.renderToScreen=!0,this.passes=[],this.copyPass=new nl(Zc),this.copyPass.material.blending=0,this.timer=new pa}swapBuffers(){let e=this.readBuffer;this.readBuffer=this.writeBuffer,this.writeBuffer=e}addPass(e){this.passes.push(e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}insertPass(e,t){this.passes.splice(t,0,e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}removePass(e){let t=this.passes.indexOf(e);t!==-1&&this.passes.splice(t,1)}isLastEnabledPass(e){for(let t=e+1;t<this.passes.length;t++)if(this.passes[t].enabled)return!1;return!0}render(e){this.timer.update(),e===void 0&&(e=this.timer.getDelta());let t=this.renderer.getRenderTarget(),n=!1;for(let t=0,r=this.passes.length;t<r;t++){let r=this.passes[t];if(r.enabled!==!1){if(r.renderToScreen=this.renderToScreen&&this.isLastEnabledPass(t),r.render(this.renderer,this.writeBuffer,this.readBuffer,e,n),r.needsSwap){if(n){let t=this.renderer.getContext(),n=this.renderer.state.buffers.stencil;n.setFunc(t.NOTEQUAL,1,4294967295),this.copyPass.render(this.renderer,this.writeBuffer,this.readBuffer,e),n.setFunc(t.EQUAL,1,4294967295)}this.swapBuffers()}rl!==void 0&&(r instanceof rl?n=!0:r instanceof il&&(n=!1))}}this.renderer.setRenderTarget(t)}reset(e){if(e===void 0){let t=this.renderer.getSize(new K);this._pixelRatio=this.renderer.getPixelRatio(),this._width=t.width,this._height=t.height,e=this.renderTarget1.clone(),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.renderTarget1=e,this.renderTarget2=e.clone(),this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2}setSize(e,t){this._width=e,this._height=t;let n=this._width*this._pixelRatio,r=this._height*this._pixelRatio;this.renderTarget1.setSize(n,r),this.renderTarget2.setSize(n,r);for(let e=0;e<this.passes.length;e++)this.passes[e].setSize(n,r)}setPixelRatio(e){this._pixelRatio=e,this.setSize(this._width,this._height)}dispose(){this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.copyPass.dispose()}},ol=class extends Qc{constructor(e,t,n=null,r=null,i=null){super(),this.scene=e,this.camera=t,this.overrideMaterial=n,this.clearColor=r,this.clearAlpha=i,this.clear=!0,this.clearDepth=!1,this.needsSwap=!1,this.isRenderPass=!0,this._oldClearColor=new Z}render(e,t,n){let r=e.autoClear;e.autoClear=!1;let i,a;this.overrideMaterial!==null&&(a=this.scene.overrideMaterial,this.scene.overrideMaterial=this.overrideMaterial),this.clearColor!==null&&(e.getClearColor(this._oldClearColor),e.setClearColor(this.clearColor,e.getClearAlpha())),this.clearAlpha!==null&&(i=e.getClearAlpha(),e.setClearAlpha(this.clearAlpha)),this.clearDepth==1&&e.clearDepth(),e.setRenderTarget(this.renderToScreen?null:n),this.clear===!0&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),e.render(this.scene,this.camera),this.clearColor!==null&&e.setClearColor(this._oldClearColor),this.clearAlpha!==null&&e.setClearAlpha(i),this.overrideMaterial!==null&&(this.scene.overrideMaterial=a),e.autoClear=r}},sl={name:`LuminosityHighPassShader`,uniforms:{tDiffuse:{value:null},luminosityThreshold:{value:1},smoothWidth:{value:1},defaultColor:{value:new Z(0)},defaultOpacity:{value:0}},vertexShader:`
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
		...
		}`},cl=class e extends Qc{constructor(e,t=1,n,r){super(),this.strength=t,this.radius=n,this.threshold=r,this.resolution=e===void 0?new K(256,256):new K(e.x,e.y),this.clearColor=new Z(0,0,0),this.needsSwap=!1,this.renderTargetsHorizontal=[],this.renderTargetsVertical=[],this.nMips=5;let i=Math.round(this.resolution.x/2),a=Math.round(this.resolution.y/2);this.renderTargetBright=new Nt(i,a,{type:T,depthBuffer:!1}),this.renderTargetBright.texture.name=`UnrealBloomPass.bright`,this.renderTargetBright.texture.generateMipmaps=!1;for(let e=0;e<this.nMips;e++){let t=new Nt(i,a,{type:T,depthBuffer:!1});t.texture.name=`UnrealBloomPass.h`+e,t.texture.generateMipmaps=!1,this.renderTargetsHorizontal.push(t);let n=new Nt(i,a,{type:T,depthBuffer:!1});n.texture.name=`UnrealBloomPass.v`+e,n.texture.generateMipmaps=!1,this.renderTargetsVertical.push(n),i=Math.round(i/2),a=Math.round(a/2)}let o=sl;this.highPassUniforms=_i.clone(o.uniforms),this.highPassUniforms.luminosityThreshold.value=r,this.highPassUniforms.smoothWidth.value=.01,this.materialHighPassFilter=new bi({uniforms:this.highPassUniforms,vertexShader:o.vertexShader,fragmentShader:o.fragmentShader}),this.separableBlurMaterials=[];let s=[6,10,14,18,22];i=Math.round(this.resolution.x/2),a=Math.round(this.resolution.y/2);for(let e=0;e<this.nMips;e++)this.separableBlurMaterials.push(this._getSeparableBlurMaterial(s[e])),this.separableBlurMaterials[e].uniforms.invSize.value=new K(1/i,1/a),i=Math.round(i/2),a=Math.round(a/2);this.compositeMaterial=this._getCompositeMaterial(this.nMips),this.compositeMaterial.uniforms.blurTexture1.value=this.renderTargetsVertical[0].texture,this.compositeMaterial.uniforms.blurTexture2.value=this.renderTargetsVertical[1].texture,this.compositeMaterial.uniforms.blurTexture3.value=this.renderTargetsVertical[2].texture,this.compositeMaterial.uniforms.blurTexture4.value=this.renderTargetsVertical[3].texture,this.compositeMaterial.uniforms.blurTexture5.value=this.renderTargetsVertical[4].texture,this.compositeMaterial.uniforms.bloomStrength.value=t,this.compositeMaterial.uniforms.bloomRadius.value=.1;let c=[1,.8,.6,.4,.2];this.compositeMaterial.uniforms.bloomFactors.value=c,this.bloomTintColors=[new q(1,1,1),new q(1,1,1),new q(1,1,1),new q(1,1,1),new q(1,1,1)],this.compositeMaterial.uniforms.bloomTintColors.value=this.bloomTintColors,this.copyUniforms=_i.clone(Zc.uniforms),this.blendMaterial=new bi({uniforms:this.copyUniforms,vertexShader:Zc.vertexShader,fragmentShader:Zc.fragmentShader,premultipliedAlpha:!0,blending:2,depthTest:!1,depthWrite:!1,transparent:!0}),this._oldClearColor=new Z,this._oldClearAlpha=1,this._basic=new Ar,this._fsQuad=new tl(null)}dispose(){for(let e=0;e<this.renderTargetsHorizontal.length;e++)this.renderTargetsHorizontal[e].dispose();for(let e=0;e<this.renderTargetsVertical.length;e++)this.renderTargetsVertical[e].dispose();this.renderTargetBright.dispose();for(let e=0;e<this.separableBlurMaterials.length;e++)this.separableBlurMaterials[e].dispose();this.compositeMaterial.dispose(),this.blendMaterial.dispose(),this._basic.dispose(),this._fsQuad.dispose()}setSize(e,t){let n=Math.round(e/2),r=Math.round(t/2);this.renderTargetBright.setSize(n,r);for(let e=0;e<this.nMips;e++)this.renderTargetsHorizontal[e].setSize(n,r),this.renderTargetsVertical[e].setSize(n,r),this.separableBlurMaterials[e].uniforms.invSize.value=new K(1/n,1/r),n=Math.round(n/2),r=Math.round(r/2)}render(t,n,r,i,a){t.getClearColor(this._oldClearColor),this._oldClearAlpha=t.getClearAlpha();let o=t.autoClear;t.autoClear=!1,t.setClearColor(this.clearColor,0),a&&t.state.buffers.stencil.setTest(!1),this.renderToScreen&&(this._fsQuad.material=this._basic,this._basic.map=r.texture,t.setRenderTarget(null),t.clear(),this._fsQuad.render(t)),this.highPassUniforms.tDiffuse.value=r.texture,this.highPassUniforms.luminosityThreshold.value=this.threshold,this._fsQuad.material=this.materialHighPassFilter,t.setRenderTarget(this.renderTargetBright),t.clear(),this._fsQuad.render(t);let s=this.renderTargetBright;for(let n=0;n<this.nMips;n++)this._fsQuad.material=this.separableBlurMaterials[n],this.separableBlurMaterials[n].uniforms.colorTexture.value=s.texture,this.separableBlurMaterials[n].uniforms.direction.value=e.BlurDirectionX,t.setRenderTarget(this.renderTargetsHorizontal[n]),t.clear(),this._fsQuad.render(t),this.separableBlurMaterials[n].uniforms.colorTexture.value=this.renderTargetsHorizontal[n].texture,this.separableBlurMaterials[n].uniforms.direction.value=e.BlurDirectionY,t.setRenderTarget(this.renderTargetsVertical[n]),t.clear(),this._fsQuad.render(t),s=this.renderTargetsVertical[n];this._fsQuad.material=this.compositeMaterial,this.compositeMaterial.uniforms.bloomStrength.value=this.strength,this.compositeMaterial.uniforms.bloomRadius.value=this.radius,this.compositeMaterial.uniforms.bloomTintColors.value=this.bloomTintColors,t.setRenderTarget(this.renderTargetsHorizontal[0]),t.clear(),this._fsQuad.render(t),this._fsQuad.material=this.blendMaterial,this.copyUniforms.tDiffuse.value=this.renderTargetsHorizontal[0].texture,a&&t.state.buffers.stencil.setTest(!0),this.renderToScreen?(t.setRenderTarget(null),this._fsQuad.render(t)):(t.setRenderTarget(r),this._fsQuad.render(t)),t.setClearColor(this._oldClearColor,this._oldClearAlpha),t.autoClear=o}_getSeparableBlurMaterial(e){let t=[],n=e/3;for(let r=0;r<e;r++)t.push(.39894*Math.exp(-.5*r*r/(n*n))/n);let r=[],i=[];for(let n=1;n<e;n+=2){let a=t[n],o=n+1<e?t[n+1]:0,s=a+o;r.push((n*a+(n+1)*o)/s),i.push(s)}return new bi({defines:{KERNEL_PAIRS:r.length},uniforms:{colorTexture:{value:null},invSize:{value:new K(.5,.5)},direction:{value:new K(.5,.5)},centerWeight:{value:t[0]},gaussianOffsets:{value:r},gaussianWeights:{value:i}},vertexShader:`
				...
				}`})}};cl.BlurDirectionX=new K(1,0),cl.BlurDirectionY=new K(0,1);var ll={name:`OutputShader`,uniforms:{tDiffuse:{value:null},toneMappingExposure:{value:1}},vertexShader:`
		precision highp float;
		...
		}`},ul=class extends Qc{constructor(){super(),this.isOutputPass=!0,this.uniforms=_i.clone(ll.uniforms),this.material=new xi({name:ll.name,uniforms:this.uniforms,vertexShader:ll.vertexShader,fragmentShader:ll.fragmentShader}),this._fsQuad=new tl(this.material),this._outputColorSpace=null,this._toneMapping=null}render(e,t,n){this.uniforms.tDiffuse.value=n.texture,this.uniforms.toneMappingExposure.value=e.toneMappingExposure,(this._outputColorSpace!==e.outputColorSpace||this._toneMapping!==e.toneMapping)&&(this._outputColorSpace=e.outputColorSpace,this._toneMapping=e.toneMapping,this.material.defines={},Y.getTransfer(this._outputColorSpace)===`srgb`&&(this.material.defines.SRGB_TRANSFER=``),this._toneMapping===1?this.material.defines.LINEAR_TONE_MAPPING=``:this._toneMapping===2?this.material.defines.REINHARD_TONE_MAPPING=``:this._toneMapping===3?this.material.defines.CINEON_TONE_MAPPING=``:this._toneMapping===4?this.material.defines.ACES_FILMIC_TONE_MAPPING=``:this._toneMapping===6?this.material.defines.AGX_TONE_MAPPING=``:this._toneMapping===7?this.material.defines.NEUTRAL_TONE_MAPPING=``:this._toneMapping===5&&(this.material.defines.CUSTOM_TONE_MAPPING=``),this.material.needsUpdate=!0),this.renderToScreen===!0?(e.setRenderTarget(null),this._fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this._fsQuad.render(e))}dispose(){this.material.dispose(),this._fsQuad.dispose()}},dl=`modulepreload`,fl=function(e){return`/gateway/`+e},pl={},ml=function(e,t,n){let r=Promise.resolve();if(t&&t.length>0){let e=document.getElementsByTagName(`link`),i=document.querySelector(`meta[property=csp-nonce]`),a=i?.nonce||i?.getAttribute(`nonce`);function o(e){return Promise.all(e.map(e=>Promise.resolve(e).then(e=>({status:`fulfilled`,value:e}),e=>({status:`rejected`,reason:e}))))}function s(e){return import.meta.resolve?import.meta.resolve(e):new URL(e,import.meta.url).href}r=o(t.map(t=>{if(t=fl(t,n),t=s(t),t in pl)return;pl[t]=!0;let r=t.endsWith(`.css`);for(let n=e.length-1;n>=0;n--){let i=e[n];if(i.href===t&&(!r||i.rel===`stylesheet`))return}let i=document.createElement(`link`);if(i.rel=r?`stylesheet`:dl,r||(i.as=`script`),i.crossOrigin=``,i.href=t,a&&i.setAttribute(`nonce`,a),document.head.appendChild(i),r)return new Promise((e,n)=>{i.addEventListener(`load`,e),i.addEventListener(`error`,()=>n(Error(`Unable to preload CSS for ${t}`)))})}))}function i(e){let t=new Event(`vite:preloadError`,{cancelable:!0});if(t.payload=e,window.dispatchEvent(t),!t.defaultPrevented)throw e}return r.then(t=>{for(let e of t||[])e.status===`rejected`&&i(e.reason);return e().catch(i)})};Jc.init();var hl={bg:1053464,fog:790291,accent:14251863,ledGreen:3066993,ledAmber:15105570,ledRed:15158332,ledIdle:670250,rack:1316635,floor:724240},gl={green:{c:new Z(hl.ledGreen),k:1.9},amber:{c:new Z(hl.ledAmber),k:2.6},red:{c:new Z(hl.ledRed),k:3.4},off:{c:new Z(hl.ledIdle),k:1}};function _l(e){let t=Math.random();return e?t<.4?gl.green:t<.75?gl.amber:t<.9?gl.red:gl.off:t<.7?gl.green:t<.9?gl.off:gl.amber}var vl=document.getElementById(`app`),yl=new Kc({antialias:!0,powerPreference:`high-performance`});yl.setPixelRatio(Math.min(window.devicePixelRatio,2)),yl.setSize(window.innerWidth,window.innerHeight),yl.toneMapping=4,yl.toneMappingExposure=1.15,yl.info.autoReset=!1,vl.appendChild(yl.domElement);var bl=new yn;bl.background=new Z(hl.bg),bl.fog=new vn(hl.fog,.045);var xl=new ia(58,window.innerWidth/window.innerHeight,.1,120);xl.rotation.order=`YXZ`;var Sl=new Ki(3555661,329482,.22);bl.add(Sl);var Cl=new ca(5929612,2.2,2.2,46);Cl.position.set(0,4.6,-12),Cl.lookAt(0,0,8),bl.add(Cl);var wl=new Si({color:921876,roughness:.62,metalness:.35}),Tl=new Si({color:1909545,roughness:.5,metalness:.42}),El=new Si({color:922647,roughness:.5,metalness:.3,emissive:1002058,emissiveIntensity:.25}),Dl=new Ar({color:16777215});{let e=new Qa(yl);bl.environment=e.fromScene(new Yc,.04).texture,bl.environmentIntensity=.3,e.dispose()}var Ol=new Si({color:hl.floor,roughness:.28,metalness:.75,envMapIntensity:.6}),kl=new Hr(new ui(9,64),Ol);kl.rotation.x=-Math.PI/2,kl.position.z=-16,bl.add(kl);{let e=new Ar({color:1119514}),t=[];for(let e=-46;e<=14;e+=2.4)t.push(e);let n=new ei(new ui(9,.035),e,t.length),r=new ln;t.forEach((e,t)=>{r.position.set(0,.002,e),r.rotation.set(-Math.PI/2,0,0),r.updateMatrix(),n.setMatrixAt(t,r.matrix)}),n.frustumCulled=!1,bl.add(n)}var Al=(()=>{let e=20260909;return()=>(e=(e*1664525+1013904223)%4294967296)/4294967296})(),jl={perSide:16,pitch:2.9,z0:10,x:1.45,unitH:.064,W:.62,D:.9},Ml=[-.21,-.12,-.03,.06,.15],Nl=[];for(let e=0;e<jl.perSide;e++){let t=e===3;for(let n of[-1,1])Nl.push({pos:new q(n*jl.x,0,jl.z0-e*jl.pitch),rotY:-n*Math.PI/2,units:26+Math.floor(Al()*9),hot:t})}var Pl=Nl.map(e=>Array.from({length:e.units},()=>3+Math.floor(Al()*3))),Fl=Nl.reduce((e,t)=>e+t.units,0),Il=Pl.reduce((e,t)=>e+t.reduce((e,t)=>e+t,0),0),Ll=new li(1,1,1),Rl=new li(jl.W-.06,.05,.02),zl=new di(.0055,6,5),Bl=new ei(Ll,wl,Nl.length),Vl=new ei(Ll,El,Nl.length),Hl=new ei(Rl,Tl,Fl),Ul=new ei(zl,Dl,Il);for(let e of[Bl,Vl,Hl,Ul])e.frustumCulled=!1;var Wl=new Uint8Array(Il);{let e=new ln,t=new Z,n=new mt,r=new q,i=0,a=0,o=0,s=0;for(let c=0;c<Nl.length;c++){let l=Nl[c],u=l.units*jl.unitH+.12;n.setFromEuler(new Gt(0,l.rotY,0)),e.quaternion.copy(n),r.set(0,u/2,0).applyQuaternion(n),e.position.copy(l.pos).add(r),e.scale.set(jl.W,u,jl.D),e.updateMatrix(),Bl.setMatrixAt(i++,e.matrix),e.quaternion.copy(n),r.set(0,u-.016,jl.D/2+.006).applyQuaternion(n),e.position.copy(l.pos).add(r),e.scale.set(jl.W,.024,.03),e.updateMatrix(),Vl.setMatrixAt(a++,e.matrix);for(let i=0;i<l.units;i++){let a=.07+i*jl.unitH;e.quaternion.copy(n),r.set(0,a,jl.D/2+.011).applyQuaternion(n),e.position.copy(l.pos).add(r),e.scale.set(1,1,1),e.updateMatrix(),Hl.setMatrixAt(o++,e.matrix);for(let o=0;o<Pl[c][i];o++){e.quaternion.copy(n),r.set(Ml[o],a+.004,jl.D/2+.024).applyQuaternion(n),e.position.copy(l.pos).add(r),e.scale.set(1,1,1),e.updateMatrix(),Ul.setMatrixAt(s,e.matrix);let i=_l(l.hot);Ul.setColorAt(s,t.copy(i.c).multiplyScalar(i.k)),Wl[s]=+!!l.hot,s++}}}Bl.instanceMatrix.needsUpdate=!0,Vl.instanceMatrix.needsUpdate=!0,Hl.instanceMatrix.needsUpdate=!0,Ul.instanceMatrix.needsUpdate=!0}bl.add(Bl,Vl,Hl,Ul);var Gl=new Z;function Kl(){let e=Math.max(1,Math.round(Ul.count*.01));for(let t=0;t<e;t++){let e=Math.random()*Ul.count|0,t=_l(Wl[e]===1);Ul.setColorAt(e,Gl.copy(t.c).multiplyScalar(t.k))}Ul.instanceColor&&(Ul.instanceColor.needsUpdate=!0)}{let e=new Hr(new ui(9,64),new Si({color:526861,roughness:.95}));e.rotation.x=Math.PI/2,e.position.set(0,4.4,-16),bl.add(e);let t=new Si({color:1316893,roughness:.55,metalness:.5});for(let e of[-.7,.7]){let n=new Hr(new li(.3,.06,62),t);n.position.set(e,4.33,-16),bl.add(n)}}var ql=new oa(hl.accent,60,34,2);ql.position.set(0,1.6,-45),bl.add(ql);var Jl=new Hr(new di(.5,24,24),new Ar({color:new Z(hl.accent).multiplyScalar(4)}));Jl.position.copy(ql.position),bl.add(Jl);var Yl=e=>Math.min(1,Math.max(0,e));function Xl(e,t=0,n=0){let r=Yl(e),i=.18*Math.sin(r*Math.PI*3);xl.position.set(i,1.6,11-46*r),xl.rotation.set(n-.035,t,0)}var Zl=0,Ql=0,$l=0,eu=0,tu=0,nu=0,ru=window.matchMedia(`(prefers-reduced-motion: reduce)`),iu=ru.matches;ru.addEventListener?.(`change`,e=>{iu=e.matches});var au=window.matchMedia(`(pointer: coarse)`).matches,ou=document.getElementById(`hint`),su=!1;function cu(){!su&&ou&&(su=!0,ou.style.transition=`opacity .6s ease`,ou.style.opacity=`0`,setTimeout(()=>ou.remove(),700))}function lu(e){Zl=Yl(Zl+e),cu()}window.addEventListener(`wheel`,e=>{e.preventDefault(),lu((e.deltaMode===1?e.deltaY*16:e.deltaY)*45e-5)},{passive:!1}),window.addEventListener(`keydown`,e=>{let t={ArrowDown:.08,PageDown:.25," ":.25,ArrowUp:-.08,PageUp:-.25}[e.key];t!==void 0&&(e.preventDefault(),lu(t))});var uu=null;window.addEventListener(`touchstart`,e=>{e.touches.length===1&&(uu=e.touches[0].clientY,cu())},{passive:!0}),window.addEventListener(`touchmove`,e=>{if(e.touches.length!==1||uu===null)return;e.preventDefault();let t=e.touches[0].clientY;lu((uu-t)*.0022),uu=t},{passive:!1}),au||window.addEventListener(`mousemove`,e=>{tu=-(e.clientX/window.innerWidth*2-1)*.25,nu=-(e.clientY/window.innerHeight*2-1)*.25});var du=new URLSearchParams(location.search),fu=[];du.has(`shots`)&&(window.__QA={cameraAt:Xl,async shoot(){let{captureShots:e}=await ml(async()=>{let{captureShots:e}=await import(`./qa-shots-DyV2NsKV.js`);return{captureShots:e}},[]);return await e({renderer:yl,composer:pu,camera:xl,cameraAt:Xl},[{name:`w00`,scroll:0},{name:`w25`,scroll:.25},{name:`w50`,scroll:.5},{name:`w75`,scroll:.75},{name:`w100`,scroll:1},{name:`rack-close`,pos:[.12,1.32,1.3],look:[1.45,1.12,1.3]}],fu),Xl(Ql,$l,eu),fu}});var pu=new al(yl);pu.addPass(new ol(bl,xl)),pu.addPass(new cl(new K(window.innerWidth,window.innerHeight),.38,.35,.88)),pu.addPass(new ul);var mu=0,hu=performance.now(),gu=60,_u=performance.now();Xl(Ql),yl.setAnimationLoop(e=>{let t=Math.min(.05,Math.max(1e-4,(e-_u)/1e3));_u=e;let n=e/1e3;if(Ql=iu?Zl:Ql+(Zl-Ql)*Math.min(1,t*3),!iu&&!au&&($l+=(tu-$l)*Math.min(1,t*3),eu+=(nu-eu)*Math.min(1,t*3)),Xl(Ql,$l,eu),Jl.scale.setScalar(1+.04*Math.sin(n*.9)),iu||Kl(),mu++,yl.info.reset(),pu.render(),mu%30==0){let e=performance.now();gu=Math.round(mu*1e3/(e-hu)),mu=0,hu=e;let t=document.getElementById(`q`);t&&(t.textContent=`${gu} fps · ${yl.info.render.calls} draw calls · ${yl.info.render.triangles.toLocaleString()} tris`)}}),window.addEventListener(`resize`,()=>{xl.aspect=window.innerWidth/window.innerHeight,xl.updateProjectionMatrix(),yl.setSize(window.innerWidth,window.innerHeight),pu.setSize(window.innerWidth,window.innerHeight)});